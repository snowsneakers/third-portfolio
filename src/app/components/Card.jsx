...
export default function Card({ project, loading }) {
    ...
    >
      ...
      <div className="relative rounded-[3px] overflow-hidden select-none aspect-video">
        {loading ? (
          <div
            role="overlay"
            className="absolute bg-black/20 top-0 left-0 w-full h-full flex items-center justify-center rounded-[3px] transition duration-200"
          >
            <svg
